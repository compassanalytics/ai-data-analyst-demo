...
def generate_super_table(n_rows: int = 50000) -> pd.DataFrame:
        ...
        records.append(
            {
                ...
                "category": {"BER": "Beer", "CID": "Cider", "RTD": "Ready-to-Drink", "NAB": "Non-Alcoholic"}[
                    category_code
                ],
                "CATEGORY": {"BER": "BEER", "CID": "CIDER", "RTD": "RTD", "NAB": "NA"}[
                    category_code
                ],  # Different again!
                "subcat": subcategory,
                "sub_category": subcategory,
                "brnd": random.choice(["NB", "MG", "CS", "HL", "OF", "VC", "SH", "PS", "ZP", "PF", "BO"]),
                "brand_code": random.choice(
                    ["NORTH", "MOUNT", "CRAFT", "HERIT", "ORCH", "VALL", "SOC", "PARTY", "ZERO", "PURE", "BOOST"]
                ),
                ...
                "customer_type": random.choice(
                    ["Bar/Restaurant", "Liquor Store", "Grocery", "Convenience", "Hotel", "Stadium"]
                ),
                "seg": cust_segment,
                "segment": {"ENT": "Enterprise", "MID": "Mid-Market", "SMB": "Small Business", "IND": "Independent"}[
                    cust_segment
                ],
    ...
    print("  Revenue columns: net_amt, net_sales, NET, net_revenue, revenue, REVENUE, REV")
    print("  Quantity columns: qty, quantity, QTY_SOLD, units, unit_sold")
    print("  Date columns: sale_date, SaleDate, trans_dt, order_date_iso, dt")
