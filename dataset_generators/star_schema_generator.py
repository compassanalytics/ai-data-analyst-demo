...
from .base import BaseDataGenerator, GeneratorConfig
...
class StarSchemaGenerator(BaseDataGenerator):
    ...
    def generate(self) -> dict[str, pd.DataFrame]:
        ...
        fact_sales = self._generate_fact_sales(dim_date, dim_product, dim_customer, dim_store, dim_promotion)
...
def generate_star_schema(output_dir: str | None = None) -> dict:
    """
    Generate complete star schema dataset.
