...
from .unified_generator import generate_dataset, CleanlinessLevel
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate datasets for AI Data Analyst Workshop'
    )
    parser.add_argument(
        '--cleanliness', '-c',
        type=int,
    ...
    if args.level:
        ...
        result, queries = generate_dataset(
